...
response.logo = A(B('Ask&Answer'),XML('&trade;&nbsp;'),
                  _class="navbar-brand",_href="http://127.0.0.1:8000/QuestionAnswer/default/index",
                  _id="web2py-logo")
...
if auth.has_membership('Expert'):
    ...
    (T('Notifications'), False, URL('default', 'noti'), [])]
